...
public class JavaIssue12Cfg {
  ...
  public java.lang.String toPropString() { return toPropString(""); }
  public java.lang.String toPropString(java.lang.String p) {
    return this.Boolean.toPropString(p+"Boolean.")
        +this.Option.toPropString(p+"Option.")
        +this.String.toPropString(p+"String.")
        +this.int_.toPropString(p+"int_.");
  }
