// generated by tscfg 0.3.3 on Thu Aug 25 19:43:52 PDT 2016
...
public class ExampleCfg {
  ...
  public static class Endpoint {
    ...
    public Endpoint(com.typesafe.config.Config c) {
      ...
      this.interface_ = new Interface(c.hasPath("interface") ? c.getConfig("interface") : null);
  ...
  public ExampleCfg(com.typesafe.config.Config c) {
    this.endpoint = new Endpoint(c.hasPath("endpoint") ? c.getConfig("endpoint") : null);
  }
  public String toString() { return toString(""); }
  public String toString(String i) {
