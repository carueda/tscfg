    ...
    public Test(
      ...
      this.impl =
          c.hasPathOrNull("impl")
              ? new ImplB(c.getConfig("impl"), parentPath + "impl.", $tsCfgValidator)
              : new ImplB(
  ...
  public JavaIssue67aCfg(com.typesafe.config.Config c) {
    ...
    this.test =
        c.hasPathOrNull("test")
            ? new JavaIssue67aCfg.Test(c.getConfig("test"), parentPath + "test.", $tsCfgValidator)
            : new JavaIssue67aCfg.Test(
