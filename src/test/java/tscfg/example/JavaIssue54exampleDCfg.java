...
public class JavaIssue54exampleDCfg {
  ...
  public static class ExampleD {
    ...
    public ExampleD(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  public JavaIssue54exampleDCfg(com.typesafe.config.Config c) {
    ...
    this.exampleD = c.hasPathOrNull("exampleD") ? new JavaIssue54exampleDCfg.ExampleD(c.getConfig("exampleD"), parentPath + "exampleD.", $tsCfgValidator) : new JavaIssue54exampleDCfg.ExampleD(com.typesafe.config.ConfigFactory.parseString("exampleD{}"), parentPath + "exampleD.", $tsCfgValidator);
