  ...
  public static class Test {
    ...
    public Test(
      ...
      this.loadModelConfig =
          c.hasPathOrNull("loadModelConfig")
              ? new LoadModelConfig(
                  c.getConfig("loadModelConfig"), parentPath + "loadModelConfig.", $tsCfgValidator)
              : new LoadModelConfig(
                  com.typesafe.config.ConfigFactory.parseString("loadModelConfig{}"),
