...
public class JavaIssue62bCfg {
  ...
  public static class Foo {
    ...
    public static class Other {
      ...
      public Other(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    ...
    public Foo(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      ...
      this.other = c.hasPathOrNull("other") ? new Foo.Other(c.getConfig("other"), parentPath + "other.", $tsCfgValidator) : new Foo.Other(com.typesafe.config.ConfigFactory.parseString("other{}"), parentPath + "other.", $tsCfgValidator);
  ...
  public JavaIssue62bCfg(com.typesafe.config.Config c) {
    ...
    this.foo = c.hasPathOrNull("foo") ? new JavaIssue62bCfg.Foo(c.getConfig("foo"), parentPath + "foo.", $tsCfgValidator) : new JavaIssue62bCfg.Foo(com.typesafe.config.ConfigFactory.parseString("foo{}"), parentPath + "foo.", $tsCfgValidator);
