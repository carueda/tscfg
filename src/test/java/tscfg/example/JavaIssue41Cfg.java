...
public class JavaIssue41Cfg {
  ...
  public static class C {
    ...
    public static class F {
      ...
      public F(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    ...
    public C(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      this.d = c.hasPathOrNull("d") ? java.util.Optional.of(c.getString("d")) : java.util.Optional.empty();
      this.e = c.hasPathOrNull("e") ? c.getString("e") : "hello";
      this.f = c.hasPathOrNull("f") ? java.util.Optional.of(new C.F(c.getConfig("f"), parentPath + "f.", $tsCfgValidator)) : java.util.Optional.empty();
    }
  }
  ...
  public JavaIssue41Cfg(com.typesafe.config.Config c) {
    ...
    this.a = c.hasPathOrNull("a") ? java.util.Optional.of(c.getInt("a")) : java.util.Optional.empty();
    this.b = c.hasPathOrNull("b") ? c.getInt("b") : 10;
    this.c = c.hasPathOrNull("c") ? new JavaIssue41Cfg.C(c.getConfig("c"), parentPath + "c.", $tsCfgValidator) : new JavaIssue41Cfg.C(com.typesafe.config.ConfigFactory.parseString("c{}"), parentPath + "c.", $tsCfgValidator);
    this.i = c.hasPathOrNull("i") ? java.util.Optional.of($_L$_dbl(c.getList("i"), parentPath, $tsCfgValidator)) : java.util.Optional.empty();
