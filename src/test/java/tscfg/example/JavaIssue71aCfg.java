...
public class JavaIssue71aCfg {
  ...
  public JavaIssue71aCfg(com.typesafe.config.Config c) {
    ...
    this.example = c.hasPathOrNull("example") ? new JavaIssue71aCfg.Example(c.getConfig("example"), parentPath + "example.", $tsCfgValidator) : new JavaIssue71aCfg.Example(com.typesafe.config.ConfigFactory.parseString("example{}"), parentPath + "example.", $tsCfgValidator);
