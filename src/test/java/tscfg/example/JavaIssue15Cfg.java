...
public class JavaIssue15Cfg {
  ...
  public static class Positions$Elm {
    ...
    public static class Positions$Elm2 {
      ...
      public Positions$Elm2(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    ...
    public Positions$Elm(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      ...
      this.positions = $_L$_LPositions$Elm_Positions$Elm2(c.getList("positions"), parentPath, $tsCfgValidator);
    }
    private static java.util.List<java.util.List<Positions$Elm.Positions$Elm2>> $_L$_LPositions$Elm_Positions$Elm2(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      java.util.ArrayList<java.util.List<Positions$Elm.Positions$Elm2>> al = new java.util.ArrayList<>();
      for (com.typesafe.config.ConfigValue cv: cl) {
        al.add($_LPositions$Elm_Positions$Elm2((com.typesafe.config.ConfigList)cv, parentPath, $tsCfgValidator));
      }
      return java.util.Collections.unmodifiableList(al);
    }
    private static java.util.List<Positions$Elm.Positions$Elm2> $_LPositions$Elm_Positions$Elm2(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      java.util.ArrayList<Positions$Elm.Positions$Elm2> al = new java.util.ArrayList<>();
      for (com.typesafe.config.ConfigValue cv: cl) {
        al.add(new Positions$Elm.Positions$Elm2(((com.typesafe.config.ConfigObject)cv).toConfig(), parentPath, $tsCfgValidator));
      }
      return java.util.Collections.unmodifiableList(al);
    }
  }
  ...
  public JavaIssue15Cfg(com.typesafe.config.Config c) {
    ...
    this.positions = $_LJavaIssue15Cfg_Positions$Elm(c.getList("positions"), parentPath, $tsCfgValidator);
    $tsCfgValidator.validate();
  }
  private static java.util.List<JavaIssue15Cfg.Positions$Elm> $_LJavaIssue15Cfg_Positions$Elm(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    java.util.ArrayList<JavaIssue15Cfg.Positions$Elm> al = new java.util.ArrayList<>();
    for (com.typesafe.config.ConfigValue cv: cl) {
      al.add(new JavaIssue15Cfg.Positions$Elm(((com.typesafe.config.ConfigObject)cv).toConfig(), parentPath, $tsCfgValidator));
    }
    return java.util.Collections.unmodifiableList(al);
  }
