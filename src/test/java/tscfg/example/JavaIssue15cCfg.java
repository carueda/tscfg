...
public class JavaIssue15cCfg {
  ...
  public static class Positions$Elm {
    ...
    private static java.util.List<java.util.List<Positions$Elm.Attrs$Elm>>
        $_L$_LPositions$Elm_Attrs$Elm(
      ...
      for (com.typesafe.config.ConfigValue cv : cl) {
        al.add(
            $_LPositions$Elm_Attrs$Elm(
                (com.typesafe.config.ConfigList) cv, parentPath, $tsCfgValidator));
      }
      return java.util.Collections.unmodifiableList(al);
    }

    private static java.util.List<Positions$Elm.Attrs$Elm> $_LPositions$Elm_Attrs$Elm(
        com.typesafe.config.ConfigList cl,
        java.lang.String parentPath,
        $TsCfgValidator $tsCfgValidator) {
  ...
  public static class Qaz {
    ...
    public static class Aa {
      ...
      private static java.util.List<Aa.Bb$Elm> $_LAa_Bb$Elm(
          com.typesafe.config.ConfigList cl,
          java.lang.String parentPath,
          $TsCfgValidator $tsCfgValidator) {
    ...
    public Qaz(
      ...
      this.aa =
          c.hasPathOrNull("aa")
              ? new Qaz.Aa(c.getConfig("aa"), parentPath + "aa.", $tsCfgValidator)
              : new Qaz.Aa(
                  com.typesafe.config.ConfigFactory.parseString("aa{}"),
                  parentPath + "aa.",
                  $tsCfgValidator);
    }
  }
  ...
  private static java.util.List<JavaIssue15cCfg.Positions$Elm> $_LJavaIssue15cCfg_Positions$Elm(
      com.typesafe.config.ConfigList cl,
      java.lang.String parentPath,
      $TsCfgValidator $tsCfgValidator) {
    ...
    for (com.typesafe.config.ConfigValue cv : cl) {
      al.add(
          new JavaIssue15cCfg.Positions$Elm(
              ((com.typesafe.config.ConfigObject) cv).toConfig(), parentPath, $tsCfgValidator));
    }
    return java.util.Collections.unmodifiableList(al);
  }
