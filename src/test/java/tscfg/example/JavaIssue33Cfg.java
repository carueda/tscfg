...
public class JavaIssue33Cfg {
  ...
  public JavaIssue33Cfg(com.typesafe.config.Config c) {
    ...
    this.endpoint = c.hasPathOrNull("endpoint") ? new JavaIssue33Cfg.Endpoint(c.getConfig("endpoint"), parentPath + "endpoint.", $tsCfgValidator) : new JavaIssue33Cfg.Endpoint(com.typesafe.config.ConfigFactory.parseString("endpoint{}"), parentPath + "endpoint.", $tsCfgValidator);
