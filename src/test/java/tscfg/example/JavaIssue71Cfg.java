...
public class JavaIssue71Cfg {
  ...
  public static class Shared2 {
    ...
    public Shared2(
      ...
      this.dddd =
          c.hasPathOrNull("dddd")
              ? new Shared2.Dddd(c.getConfig("dddd"), parentPath + "dddd.", $tsCfgValidator)
              : new Shared2.Dddd(
                  com.typesafe.config.ConfigFactory.parseString("dddd{}"),
                  parentPath + "dddd.",
                  $tsCfgValidator);
    }
  ...
  public static class Example {
    ...
    private static java.util.List<Shared2> $_LShared2(
        com.typesafe.config.ConfigList cl,
        java.lang.String parentPath,
        $TsCfgValidator $tsCfgValidator) {
