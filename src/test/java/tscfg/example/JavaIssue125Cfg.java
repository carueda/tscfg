...
public class JavaIssue125Cfg {
  public final JavaIssue125Cfg.Example example;
  public final JavaIssue125Cfg.Example getExample() { return example; }
  ...
  public static class Example {
    ...
    public final Shared getA() { return a; }
  ...
  public JavaIssue125Cfg(com.typesafe.config.Config c) {
    final $TsCfgValidator $tsCfgValidator = new $TsCfgValidator();
    final java.lang.String parentPath = "";
    this.example = c.hasPathOrNull("example") ? new JavaIssue125Cfg.Example(c.getConfig("example"), parentPath + "example.", $tsCfgValidator) : new JavaIssue125Cfg.Example(com.typesafe.config.ConfigFactory.parseString("example{}"), parentPath + "example.", $tsCfgValidator);
