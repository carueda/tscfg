...
public class JavaIssue54bCfg {
  ...
  public static class Root {
    ...
    public static class Shared {
      ...
      public Shared(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
        ...
        this.c = c.hasPathOrNull("c") ? new Shared.C(c.getConfig("c"), parentPath + "c.", $tsCfgValidator) : new Shared.C(com.typesafe.config.ConfigFactory.parseString("c{}"), parentPath + "c.", $tsCfgValidator);
      }
    ...
    public Root(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      this.e = c.hasPathOrNull("e") ? new Shared(c.getConfig("e"), parentPath + "e.", $tsCfgValidator) : new Shared(com.typesafe.config.ConfigFactory.parseString("e{}"), parentPath + "e.", $tsCfgValidator);
  ...
  public JavaIssue54bCfg(com.typesafe.config.Config c) {
    ...
    this.root = c.hasPathOrNull("root") ? new JavaIssue54bCfg.Root(c.getConfig("root"), parentPath + "root.", $tsCfgValidator) : new JavaIssue54bCfg.Root(com.typesafe.config.ConfigFactory.parseString("root{}"), parentPath + "root.", $tsCfgValidator);
