...
public class JavaExample4tplCfg {
  ...
  public static class Endpoint {
    ...
    public static class Notifications {
      ...
      private static java.util.List<Notifications.Emails$Elm> $_LNotifications_Emails$Elm(
    ...
    public Endpoint(
        ...
        $TsCfgValidator $tsCfgValidator) {
      this.notifications =
          c.hasPathOrNull("notifications")
              ? new Endpoint.Notifications(
                  c.getConfig("notifications"), parentPath + "notifications.", $tsCfgValidator)
              : new Endpoint.Notifications(
                  com.typesafe.config.ConfigFactory.parseString("notifications{}"),
      ...
      this.stuff =
          c.hasPathOrNull("stuff")
              ? new Endpoint.Stuff(c.getConfig("stuff"), parentPath + "stuff.", $tsCfgValidator)
              : null;
    }
  ...
  private static java.util.List<java.util.List<java.lang.Double>> $_L$_L$_dbl(
      com.typesafe.config.ConfigList cl,
      java.lang.String parentPath,
      $TsCfgValidator $tsCfgValidator) {
