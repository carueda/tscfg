...
public class JavaIssue23Cfg {
  ...
  private static java.util.List<java.util.List<java.lang.Long>> $_L$_L$_siz(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  private static java.util.List<java.lang.Long> $_L$_siz(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
