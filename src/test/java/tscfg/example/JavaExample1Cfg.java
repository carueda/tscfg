...
public class JavaExample1Cfg {
  ...
  public JavaExample1Cfg(com.typesafe.config.Config c) {
    ...
    this.bazOptionalWithDefault =
        c.hasPathOrNull("bazOptionalWithDefault") ? c.getString("bazOptionalWithDefault") : "hello";
    this.bazOptionalWithNoDefault =
        c.hasPathOrNull("bazOptionalWithNoDefault")
            ? c.getString("bazOptionalWithNoDefault")
            : null;
