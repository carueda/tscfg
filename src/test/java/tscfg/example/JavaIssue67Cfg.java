    ...
    public Test(
      ...
      this.impl =
          c.hasPathOrNull("impl")
              ? new ImplA(c.getConfig("impl"), parentPath + "impl.", $tsCfgValidator)
              : new ImplA(
  ...
  public JavaIssue67Cfg(com.typesafe.config.Config c) {
    ...
    this.test =
        c.hasPathOrNull("test")
            ? new JavaIssue67Cfg.Test(c.getConfig("test"), parentPath + "test.", $tsCfgValidator)
            : new JavaIssue67Cfg.Test(
