...
public class JavaIssue15bCfg {
  ...
  private static java.util.List<java.util.List<java.lang.Integer>> $_L$_L$_int(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  private static java.util.List<java.lang.Boolean> $_L$_bln(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  private static java.util.List<java.lang.Long> $_L$_lng(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
