...
public class JavaIssue15dCfg {
  ...
  public static class Baz$Elm {
    ...
    public Baz$Elm(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
  ...
  private static java.util.List<java.util.List<JavaIssue15dCfg.Baz$Elm>> $_L$_LJavaIssue15dCfg_Baz$Elm(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    java.util.ArrayList<java.util.List<JavaIssue15dCfg.Baz$Elm>> al = new java.util.ArrayList<>();
    for (com.typesafe.config.ConfigValue cv: cl) {
      al.add($_LJavaIssue15dCfg_Baz$Elm((com.typesafe.config.ConfigList)cv, parentPath, $tsCfgValidator));
    }
    return java.util.Collections.unmodifiableList(al);
  }
  private static java.util.List<JavaIssue15dCfg.Baz$Elm> $_LJavaIssue15dCfg_Baz$Elm(com.typesafe.config.ConfigList cl, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
    java.util.ArrayList<JavaIssue15dCfg.Baz$Elm> al = new java.util.ArrayList<>();
    for (com.typesafe.config.ConfigValue cv: cl) {
      al.add(new JavaIssue15dCfg.Baz$Elm(((com.typesafe.config.ConfigObject)cv).toConfig(), parentPath, $tsCfgValidator));
    }
    return java.util.Collections.unmodifiableList(al);
  }
