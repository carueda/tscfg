...
public class JavaIssue31Cfg {
  ...
  public final JavaIssue31Cfg.B getB() { return b; }
  public static class B {
    public final java.lang.String c;
    public final B.D d;
    public final java.lang.String getC() { return c; }
    public final B.D getD() { return d; }
    public static class D {
      public final boolean e;
      public final boolean getE() { return e; }
    ...
    public B(com.typesafe.config.Config c, java.lang.String parentPath, $TsCfgValidator $tsCfgValidator) {
      this.c = $_reqStr(parentPath, c, "c", $tsCfgValidator);
      this.d = c.hasPathOrNull("d") ? new B.D(c.getConfig("d"), parentPath + "d.", $tsCfgValidator) : new B.D(com.typesafe.config.ConfigFactory.parseString("d{}"), parentPath + "d.", $tsCfgValidator);
    }
  ...
  public JavaIssue31Cfg(com.typesafe.config.Config c) {
    ...
    this.b = c.hasPathOrNull("b") ? new JavaIssue31Cfg.B(c.getConfig("b"), parentPath + "b.", $tsCfgValidator) : new JavaIssue31Cfg.B(com.typesafe.config.ConfigFactory.parseString("b{}"), parentPath + "b.", $tsCfgValidator);
