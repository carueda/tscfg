...
public class JavaIssue62Cfg {
  public final JavaIssue62Cfg.Foo foo;
  ...
  public JavaIssue62Cfg(com.typesafe.config.Config c) {
    ...
    this.foo = c.hasPathOrNull("foo") ? new JavaIssue62Cfg.Foo(c.getConfig("foo"), parentPath + "foo.", $tsCfgValidator) : new JavaIssue62Cfg.Foo(com.typesafe.config.ConfigFactory.parseString("foo{}"), parentPath + "foo.", $tsCfgValidator);
