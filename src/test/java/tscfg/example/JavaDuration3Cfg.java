...
public class JavaDuration3Cfg {
  ...
  public final JavaDuration3Cfg.Durations getDurations() {
    return durations;
  }
  ...
  public static class Durations {
    ...
    public final java.time.Duration getDays() {
      return days;
    }

    public final java.time.Duration getDuration_dy() {
      return duration_dy;
    }

    public final java.time.Duration getDuration_hr() {
      return duration_hr;
    }

    public final java.time.Duration getDuration_mi() {
      return duration_mi;
    }

    public final java.time.Duration getDuration_ms() {
      return duration_ms;
    }

    public final java.time.Duration getDuration_ns() {
      return duration_ns;
    }

    public final java.time.Duration getDuration_se() {
      return duration_se;
    }

    public final java.time.Duration getDuration_µs() {
      return duration_µs;
    }

    public final java.time.Duration getHours() {
      return hours;
    }

    public final java.time.Duration getMillis() {
      return millis;
    }
