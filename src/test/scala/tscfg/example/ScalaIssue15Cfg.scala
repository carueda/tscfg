...
object ScalaIssue15Cfg {
  ...
  object Positions$Elm {
    ...
    def apply(
      ...
      ScalaIssue15Cfg.Positions$Elm(
        ...
        positions = $_L$_LScalaIssue15Cfg_Positions$Elm_Positions$Elm(
          c.getList("positions"),
          parentPath,
          $tsCfgValidator
        )
    ...
    private def $_L$_LScalaIssue15Cfg_Positions$Elm_Positions$Elm(
        cl: com.typesafe.config.ConfigList,
        parentPath: java.lang.String,
        $tsCfgValidator: $TsCfgValidator
    ): scala.List[scala.List[ScalaIssue15Cfg.Positions$Elm.Positions$Elm]] = {
      import scala.jdk.CollectionConverters._
      cl.asScala
        .map(cv =>
          $_LScalaIssue15Cfg_Positions$Elm_Positions$Elm(
    ...
    private def $_LScalaIssue15Cfg_Positions$Elm_Positions$Elm(
        cl: com.typesafe.config.ConfigList,
        parentPath: java.lang.String,
        $tsCfgValidator: $TsCfgValidator
    ): scala.List[ScalaIssue15Cfg.Positions$Elm.Positions$Elm] = {
      import scala.jdk.CollectionConverters._
      cl.asScala
        .map(cv =>
          ScalaIssue15Cfg.Positions$Elm.Positions$Elm(
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue15Cfg = {
    ...
    val $result = ScalaIssue15Cfg(
      positions =
        $_LScalaIssue15Cfg_Positions$Elm(c.getList("positions"), parentPath, $tsCfgValidator)
    )
    $tsCfgValidator.validate()
    $result
  }
  private def $_LScalaIssue15Cfg_Positions$Elm(
      cl: com.typesafe.config.ConfigList,
      parentPath: java.lang.String,
      $tsCfgValidator: $TsCfgValidator
  ): scala.List[ScalaIssue15Cfg.Positions$Elm] = {
    import scala.jdk.CollectionConverters._
    cl.asScala
      .map(cv =>
        ScalaIssue15Cfg.Positions$Elm(
