...
object ScalaIssue15dCfg {
  ...
  private def $_L$_LScalaIssue15dCfg_Baz$Elm(cl:com.typesafe.config.ConfigList, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): scala.List[scala.List[ScalaIssue15dCfg.Baz$Elm]] = {
    import scala.jdk.CollectionConverters._
    cl.asScala.map(cv => $_LScalaIssue15dCfg_Baz$Elm(cv.asInstanceOf[com.typesafe.config.ConfigList], parentPath, $tsCfgValidator)).toList
  }
  private def $_LScalaIssue15dCfg_Baz$Elm(cl:com.typesafe.config.ConfigList, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): scala.List[ScalaIssue15dCfg.Baz$Elm] = {
    import scala.jdk.CollectionConverters._
    cl.asScala.map(cv => ScalaIssue15dCfg.Baz$Elm(cv.asInstanceOf[com.typesafe.config.ConfigObject].toConfig, parentPath, $tsCfgValidator)).toList
  }
