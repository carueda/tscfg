...
object ScalaIssue14Cfg {
  ...
  object _0 {
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue14Cfg._0 = {
      ScalaIssue14Cfg._0(
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue14Cfg = {
    ...
    val $result = ScalaIssue14Cfg(
      _0 = ScalaIssue14Cfg._0(if(c.hasPathOrNull("0")) c.getConfig("0") else com.typesafe.config.ConfigFactory.parseString("0{}"), parentPath + "0.", $tsCfgValidator),
