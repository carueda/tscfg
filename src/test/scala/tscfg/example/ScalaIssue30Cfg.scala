...
object ScalaIssue30Cfg {
  ...
  object `Foo-object` {
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue30Cfg.`Foo-object` = {
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue30Cfg = {
    ...
    val $result = ScalaIssue30Cfg(
      `foo-object`  = ScalaIssue30Cfg.`Foo-object`(if(c.hasPathOrNull("foo-object")) c.getConfig("foo-object") else com.typesafe.config.ConfigFactory.parseString("foo-object{}"), parentPath + "foo-object.", $tsCfgValidator),
