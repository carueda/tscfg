...
object ScalaIssue54exampleECfg {
  ...
  object Struct {
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue54exampleECfg.Struct = {
  ...
  object ExampleE {
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue54exampleECfg.ExampleE = {
      ScalaIssue54exampleECfg.ExampleE(
        test = ScalaIssue54exampleECfg.Struct(if(c.hasPathOrNull("test")) c.getConfig("test") else com.typesafe.config.ConfigFactory.parseString("test{}"), parentPath + "test.", $tsCfgValidator)
      )
    }
  }
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue54exampleECfg = {
    ...
    val $result = ScalaIssue54exampleECfg(
      exampleE = ScalaIssue54exampleECfg.ExampleE(if(c.hasPathOrNull("exampleE")) c.getConfig("exampleE") else com.typesafe.config.ConfigFactory.parseString("exampleE{}"), parentPath + "exampleE.", $tsCfgValidator)
    )
