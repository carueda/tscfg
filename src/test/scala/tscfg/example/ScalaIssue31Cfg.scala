...
object ScalaIssue31Cfg {
  ...
  object B {
    ...
    object D {
      def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue31Cfg.B.D = {
        ScalaIssue31Cfg.B.D(
    ...
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue31Cfg.B = {
      ScalaIssue31Cfg.B(
        c = $_reqStr(parentPath, c, "c", $tsCfgValidator),
        d = ScalaIssue31Cfg.B.D(if(c.hasPathOrNull("d")) c.getConfig("d") else com.typesafe.config.ConfigFactory.parseString("d{}"), parentPath + "d.", $tsCfgValidator)
      )
    }
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue31Cfg = {
    ...
    val $result = ScalaIssue31Cfg(
      ...
      b = ScalaIssue31Cfg.B(if(c.hasPathOrNull("b")) c.getConfig("b") else com.typesafe.config.ConfigFactory.parseString("b{}"), parentPath + "b.", $tsCfgValidator)
    )
