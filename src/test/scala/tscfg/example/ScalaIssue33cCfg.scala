...
object ScalaIssue33cCfg {
  ...
  object Endpoint {
    ...
    object OptObj {
      def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue33cCfg.Endpoint.OptObj = {
    ...
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue33cCfg.Endpoint = {
      ScalaIssue33cCfg.Endpoint(
        optObj = ScalaIssue33cCfg.Endpoint.OptObj(if(c.hasPathOrNull("optObj")) c.getConfig("optObj") else com.typesafe.config.ConfigFactory.parseString("optObj{}"), parentPath + "optObj.", $tsCfgValidator),
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue33cCfg = {
    ...
    val $result = ScalaIssue33cCfg(
      endpoint = ScalaIssue33cCfg.Endpoint(if(c.hasPathOrNull("endpoint")) c.getConfig("endpoint") else com.typesafe.config.ConfigFactory.parseString("endpoint{}"), parentPath + "endpoint.", $tsCfgValidator)
    )
