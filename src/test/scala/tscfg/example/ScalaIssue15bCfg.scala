...
object ScalaIssue15bCfg {
  ...
  private def $_L$_L$_int(
      cl: com.typesafe.config.ConfigList,
      parentPath: java.lang.String,
      $tsCfgValidator: $TsCfgValidator
  ): scala.List[scala.List[scala.Int]] = {
    import scala.jdk.CollectionConverters._
    cl.asScala
      .map(cv =>
        $_L$_int(cv.asInstanceOf[com.typesafe.config.ConfigList], parentPath, $tsCfgValidator)
      )
      .toList
  }
  private def $_L$_bln(
  ...
  private def $_bln(cv: com.typesafe.config.ConfigValue): scala.Boolean = {
    ...
    if (
      (cv.valueType != com.typesafe.config.ConfigValueType.BOOLEAN) ||
      !u.isInstanceOf[java.lang.Boolean]
  ...
  private def $_lng(cv: com.typesafe.config.ConfigValue): scala.Long = {
    ...
    if (
      (cv.valueType != com.typesafe.config.ConfigValueType.NUMBER) ||
      !u.isInstanceOf[java.lang.Integer] && !u.isInstanceOf[java.lang.Long]
    ) throw $_expE(cv, "long")
