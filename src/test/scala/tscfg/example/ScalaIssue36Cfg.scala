...
object ScalaIssue36Cfg {
  ...
  object Obj {
    ...
    object Baz {
      def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue36Cfg.Obj.Baz = {
    ...
    object Foo {
      def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue36Cfg.Obj.Foo = {
    ...
    def apply(c: com.typesafe.config.Config, parentPath: java.lang.String, $tsCfgValidator: $TsCfgValidator): ScalaIssue36Cfg.Obj = {
      ScalaIssue36Cfg.Obj(
        baz = ScalaIssue36Cfg.Obj.Baz(if(c.hasPathOrNull("baz")) c.getConfig("baz") else com.typesafe.config.ConfigFactory.parseString("baz{}"), parentPath + "baz.", $tsCfgValidator),
        foo = ScalaIssue36Cfg.Obj.Foo(if(c.hasPathOrNull("foo")) c.getConfig("foo") else com.typesafe.config.ConfigFactory.parseString("foo{}"), parentPath + "foo.", $tsCfgValidator)
      )
    }
  }
  ...
  def apply(c: com.typesafe.config.Config): ScalaIssue36Cfg = {
    ...
    val $result = ScalaIssue36Cfg(
      obj = ScalaIssue36Cfg.Obj(if(c.hasPathOrNull("obj")) c.getConfig("obj") else com.typesafe.config.ConfigFactory.parseString("obj{}"), parentPath + "obj.", $tsCfgValidator)
    )
